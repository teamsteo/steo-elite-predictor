...
-- ============================================
-- IMPORTANT: Exécutez ce script dans un NOUVEAU projet Supabase
-- ============================================
...
-- Supprimer les anciens enums s'ils existent
...
CREATE INDEX idx_predictions_sport_date ON predictions(sport, match_date);
CREATE INDEX idx_predictions_status_date ON predictions(status, match_date);
...
CREATE INDEX idx_ml_learning_correct ON ml_learning(correct);
CREATE INDEX idx_ml_learning_confidence ON ml_learning(model_confidence);
...
CREATE INDEX idx_ml_patterns_type_sport ON ml_patterns(pattern_type, sport);
...
CREATE INDEX idx_ml_models_sport_version ON ml_models(sport, version);
...
CREATE INDEX idx_football_season ON football_matches(season);
...
CREATE INDEX idx_basketball_league ON basketball_matches(league_name);
CREATE INDEX idx_basketball_season ON basketball_matches(season);
...
CREATE INDEX idx_nhl_season ON nhl_matches(season);
...
CREATE INDEX idx_mlb_season ON mlb_matches(season);
...
VALUES
    ('v1.0-football', 'football', 0, 0),
    ('v1.0-basketball', 'basketball', 0, 0),
    ('v1.0-hockey', 'hockey', 0, 0),
    ('v1.0-other', 'other', 0, 0)
