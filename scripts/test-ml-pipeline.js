...
const { getAdaptiveThresholds, calculateMLAdjustment } = require('./src/lib/adaptiveThresholdsML');
const { scoreWithXGBoost, loadMLModel, getXGBoostStatus } = require('./src/lib/unifiedMLService');

const SPORTS = ['football', 'basketball', 'hockey', 'baseball'];

function createTestFeatureVector(sport, edge) {
  return {
